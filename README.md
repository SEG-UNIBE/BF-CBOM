...
BF-CBOM helps you understand the cryptographic landscape of your software by analyzing CBOMs generated by multiple tools.
Its primary focus is **comprehension** — exploring, comparing, and making sense of cryptographic assets detected across different generators.
For researchers and evaluators, it also offers **benchmarking capabilities** to orchestrate batch CBOM generation and evaluate tool performance at scale.
...
**[▶️ Watch the Demo Video](https://youtu.be/-YdBPHsyymU)** - See BF-CBOM's features in action with a walkthrough of the UI, benchmarking process, and analysis capabilities.
